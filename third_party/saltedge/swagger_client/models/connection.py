...
class Connection(object):
    ...
    def __init__(self, id=None, secret=None, provider_id=None, provider_code=None, provider_name=None, daily_refresh=None, customer_id=None, created_at=None, updated_at=None, last_success_at=None, status=None, country_code=None, next_refresh_possible_at=None, store_credentials=None, last_attempt=None, show_consent_confirmation=None, last_consent_id=None):  # noqa: E501
    ...
    @property
    def secret(self):
        """Gets the secret of this Connection.  # noqa: E501

        the secret key associated with a specific `connection`. It allows to read the information related to a connection using API keys of type `app`.  # noqa: E501

        :return: The secret of this Connection.  # noqa: E501
        :rtype: str
        """
        return self._secret
    ...
    def secret(self, secret):
        """Sets the secret of this Connection.

        the secret key associated with a specific `connection`. It allows to read the information related to a connection using API keys of type `app`.  # noqa: E501

        :param secret: The secret of this Connection.  # noqa: E501
        :type: str
        """
        if secret is None:
    ...
    def provider_id(self):
        """Gets the provider_id of this Connection.  # noqa: E501

        the `id` of the provider the connection belongs to  # noqa: E501

        :return: The provider_id of this Connection.  # noqa: E501
        :rtype: str
        """
    ...
    def provider_id(self, provider_id):
        """Sets the provider_id of this Connection.

        the `id` of the provider the connection belongs to  # noqa: E501

        :param provider_id: The provider_id of this Connection.  # noqa: E501
        :type: str
        """
    ...
    def provider_code(self):
        """Gets the provider_code of this Connection.  # noqa: E501

        the code of the provider the connection belongs to  # noqa: E501

        :return: The provider_code of this Connection.  # noqa: E501
        :rtype: str
        """
    ...
    def provider_code(self, provider_code):
        """Sets the provider_code of this Connection.

        the code of the provider the connection belongs to  # noqa: E501

        :param provider_code: The provider_code of this Connection.  # noqa: E501
        :type: str
        """
    ...
    def daily_refresh(self):
        """Gets the daily_refresh of this Connection.  # noqa: E501

        whether the connection will be refreshed daily  # noqa: E501

        :return: The daily_refresh of this Connection.  # noqa: E501
        :rtype: bool
        """
    ...
    def daily_refresh(self, daily_refresh):
        """Sets the daily_refresh of this Connection.

        whether the connection will be refreshed daily  # noqa: E501

        :param daily_refresh: The daily_refresh of this Connection.  # noqa: E501
        :type: bool
        """
    ...
    def last_success_at(self):
        """Gets the last_success_at of this Connection.  # noqa: E501

        time when the connection was successfully fetched  # noqa: E501

        :return: The last_success_at of this Connection.  # noqa: E501
        :rtype: datetime
        """
    ...
    def last_success_at(self, last_success_at):
        """Sets the last_success_at of this Connection.

        time when the connection was successfully fetched  # noqa: E501

        :param last_success_at: The last_success_at of this Connection.  # noqa: E501
        :type: datetime
        """
    ...
    def country_code(self):
        """Gets the country_code of this Connection.  # noqa: E501

        code of the country the provider belongs to  # noqa: E501

        :return: The country_code of this Connection.  # noqa: E501
        :rtype: str
        """
    ...
    def country_code(self, country_code):
        """Sets the country_code of this Connection.

        code of the country the provider belongs to  # noqa: E501

        :param country_code: The country_code of this Connection.  # noqa: E501
        :type: str
        """
    ...
    def next_refresh_possible_at(self):
        """Gets the next_refresh_possible_at of this Connection.  # noqa: E501
        ...
        :return: The next_refresh_possible_at of this Connection.  # noqa: E501
        :rtype: datetime
        """
    ...
    def next_refresh_possible_at(self, next_refresh_possible_at):
        """Sets the next_refresh_possible_at of this Connection.
    ...
    def store_credentials(self):
        """Gets the store_credentials of this Connection.  # noqa: E501

        whether the credentials were stored on our side  # noqa: E501

        :return: The store_credentials of this Connection.  # noqa: E501
        :rtype: bool
        """
    ...
    def store_credentials(self, store_credentials):
        """Sets the store_credentials of this Connection.

        whether the credentials were stored on our side  # noqa: E501

        :param store_credentials: The store_credentials of this Connection.  # noqa: E501
        :type: bool
        """
    ...
    def last_attempt(self):
        """Gets the last_attempt of this Connection.  # noqa: E501


        :return: The last_attempt of this Connection.  # noqa: E501
    ...
    def last_attempt(self, last_attempt):
        """Sets the last_attempt of this Connection.


        :param last_attempt: The last_attempt of this Connection.  # noqa: E501
    ...
    def show_consent_confirmation(self):
        """Gets the show_consent_confirmation of this Connection.  # noqa: E501

        whether any consent was given for this connection on Salt Edge side  # noqa: E501

        :return: The show_consent_confirmation of this Connection.  # noqa: E501
        :rtype: bool
        """
    ...
    def show_consent_confirmation(self, show_consent_confirmation):
        """Sets the show_consent_confirmation of this Connection.

        whether any consent was given for this connection on Salt Edge side  # noqa: E501

        :param show_consent_confirmation: The show_consent_confirmation of this Connection.  # noqa: E501
        :type: bool
        """
    ...
    def last_consent_id(self):
        """Gets the last_consent_id of this Connection.  # noqa: E501

        the `id` of the last [consent](#consents)  # noqa: E501

        :return: The last_consent_id of this Connection.  # noqa: E501
        :rtype: str
        """
    ...
    def last_consent_id(self, last_consent_id):
        """Sets the last_consent_id of this Connection.

        the `id` of the last [consent](#consents)  # noqa: E501

        :param last_consent_id: The last_consent_id of this Connection.  # noqa: E501
        :type: str
        """
